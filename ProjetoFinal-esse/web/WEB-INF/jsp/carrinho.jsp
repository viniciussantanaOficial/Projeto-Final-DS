                    ...
                    <c:choose>
                        <c:when test="${empty produto}">
                            ...
                            <div class="empty-cart-message">
                                ...
                                <p>Quando adicionar algo ao seu carrinho de compras, aparecerá uma mensagem aqui. Pronto
                                    para começar?</p>
                                                ...
                                                <div class="d-flex align-items-start border-bottom pb-3">
                                                    <div class="me-4">
                                                        <img style="width: 100%; height: 215px"
                                                            ...
                                                            src="data:image/jpeg;base64,${p.id_produto.imagemBase64}"
                                                            alt="100%x280">
                                                    </div>
                                                    ...
                                                    <div class="flex-grow-1 align-self-center overflow-hidden">
                                                        <div>
                                                            <h5 class="text-truncate font-size-18"><a href="#"
                                                                    class="text-dark">${p.id_produto.nome}</a></h5>
                                                            ...
                                                            <p class="mb-0 mt-1">R$${p.id_produto.valor}</p>
                                                        </div>
                                                    </div>
                                                    <form action="deletar-carrinho" method="post"
                                                        class="flex-shrink-0 ms-2">
                                                        <input type="hidden" id="idProduto" name="idProduto"
                                                            value="${p.id_produto.id_produto}">
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            <div class="d-inline-flex">
                                                                <select class="form-select form-select-sm w-xl"
                                                                    name="quantidade-${p.id_produto.id_produto}">
                                    ...
                                    <div class="mt-5 mt-lg-0">
                                        <div class="card border shadow-none">
                                            <div class="card-header bg-transparent border-bottom py-3 px-4">
                                                <h5 class="font-size-16 mb-0">Total dos produtos</h5>
                                            </div>
